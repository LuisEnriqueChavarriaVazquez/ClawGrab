    ...
    <div class="containerForm">
        ...
        <div class="containerInputsForm">
            <form action="controladorDBUsuario.php" method="post">
                <input type="hidden" id="accion" name="accion" value="registroUsuario">
                <div class="input-field col s6">
                    <i class="material-icons prefix">account_circle</i>
                    <input id="icon_name" name="txtNombre" type="text" class="validate">
                    <label for="icon_name">Nombre</label>
                </div>
                <div class="input-field col s6">
                    <i class="material-icons prefix">travel_explore</i>
                    <input id="icon_pais" name="txtPais" type="text" class="validate">
                    <label for="icon_pais">País</label>
                </div>
                <div class="input-field col s6">
                    <i class="material-icons prefix">face</i>
                    <input id="icon_edad"  name="txtEdad" type="number" class="validate">
                    <label for="icon_edad">Edad</label>
                </div>
                <br>
                <div class="input-field col s12 m6">
                    <select class="icons" name="txtIdioma">
                        ...
                        <option value="Chinnese" data-icon="img/china.png" class="left">中文</option>
                        <option value="Portuguese" data-icon="img/brazil.png" class="left">português</option>
                        <option value="Indi" data-icon="img/india.png" class="left">हिंदी</option>
                ...
                <div class="input-field col s6">
                    ...
                    <input id="icon_email" name="txtMail" type="email" class="validate">
                    <label for="icon_email">Email</label>
                </div>
                <div class="input-field col s6">
                    <i class="material-icons prefix">lock_outline</i>
                    <input id="icon_password" name="txtPassword" type="password" class="validate">
